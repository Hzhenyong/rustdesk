...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Uih12345+".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["odpdesk.remote.uih-surgical.com"];
pub const PUBLIC_RS_PUB_KEY: &str = "xYuFFXx949BUVn80Fh+ZutN88ziX1LAnmh6XEsgiY+g=";
